                    ...
                    <div class="section-detail clearfix">
                        <div class="thumb-wp fl-left">
                            <a href="" title="" id="main-thumb">
                                <img id="" src="<?php echo get_product_avatar($product['product_avatar']) ?>"/>
                            </a>
<!--                            <div id="list-thumb">
    ...
    <!--                            <p>Bộ vi xử lý :Intel Core i505200U 2.2 GHz (3MB L3)</p>
                            ...
                            <div class="num-product">
                                ...
                                <span class="status"><?php echo status_qty($product['qty']) ?></span>
                            </div>
...
<!--                            <div id="num-order-wp">
                            ...
                            <a href="?mod=cart&action=add&id=<?php echo $product['product_id'] ?>" title="Thêm giỏ hàng" class="add-cart">Thêm giỏ hàng</a>
                        </div>
                    </div>
                </div>
