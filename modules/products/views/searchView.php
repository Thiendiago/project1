        ...
        <div class="main-content fl-right">
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    ...
                    <h3 class="section-title fl-left">Có <strong><?php echo count($list_products);?></strong> sản phẩm được tìm thấy</h3>
                    <?php }else{?>
                    <h3 class="section-title fl-left">Không có sản phẩm nào được tìm thấy!</h3>
                    <?php }?>
                </div>
